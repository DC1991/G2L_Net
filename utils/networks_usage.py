...
from utils.utils_funs import get_corners
import cv2
from utils.utils_funs import define_paras,gettrans,draw_cors_lite,showpoints,get6dpose2_f
import matplotlib.pyplot as plt
import torch.nn as nn
import os
import argparse
from utils.networks_arch import Seg_3D, Point_center_res,Point_box_v_es,Point_box_R_es,Voting_vec
...
def demo_ycb(pts_ycb, rgb, rgb2,classifier,classifier_ce,classifier_box,classifier_box_gan,classifier_box_vec, pc, Rt=0, Tt=0, OR = 0, imgid = 0, temp=0):
    ...
    if len(p[0, :].nonzero()[:, 0])<10:
        ...
        show_seg = showpoints(point_ori, pred_color0, ballradius=3)
