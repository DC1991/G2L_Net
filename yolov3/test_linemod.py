...
import argparse
from yolov3.utils.utils0 import non_max_suppression
from yolov3.models import Darknet, load_darknet_weights
from utils.networks_usage import demo_ycb, load_models, define_paras
from utils.utils_funs import get_rotation, get_3D_corner, get_change_3D, depth_2_mesh_bbx, getFiles_ab, draw_mesh_3D
import cv2
...
if __name__ == '__main__':
    ...
    for il in range(0, len(lists)):
        ...
        test(rgbs, deps, idx, model, classifier, classifier_ce, classifier_box, classifier_box_gan, classifier_box_vec, opt, pc, OR, Rt, Tt, imgid=idxx, temp=temp)
